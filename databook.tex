...
Let's test it with a |GET| request.  Run the server (|venv/Scripts/python app03.py|) and, without stopping it, open a new terminal window.  In the second shell, type:
...
To test it, use the |PUT| method to change the M.I.B. agent's name to "J":
